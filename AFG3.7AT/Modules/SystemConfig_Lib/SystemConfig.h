...
#define MAX_CUSTOM_SEGMENTS                 16
#define MAX_CUSTOM_HR_SEGMENTS              4

#define MAX_SUPPORTED_USERS                 5
#define MAX_SUPPORTED_CUSTOM_PRGS           5


#define D_CUSTOM_SPEED_MPH			    500
#define D_CUSTOM_SPEED_KM			    8
#define D_CUSTOM_TIME			    60
#define D_CUSTOM_SEGMENT_TIME	    60
#define D_CUSTOM_SEGMENT_MINDISTANCE	100//放大1000倍
#define D_CUSTOM_SEGMENT_MAXDISTANCE	2000//放大1000倍
#define D_CUSTOM_INCLINE	        0
#define D_CUSTOM_RESISTANCE		    1
#define D_CUSTOM_HR_SEGMENT_TIME	60
#define D_CUSTOM_TARGET_HR          80
#define D_CUSTOM_HR_TOTAL_TIME	    15*60
...
typedef enum
{
    ...
    CUSTOM5_SEGMENTS_ARRAY_SPEEDX10,
    ...
    CUSTOM5_SEGMENTS_ARRAY_INCLINEX10,
    ...
    CUSTOM5_SEGMENTS_ARRAY_RESISTANCE,
    CUSTOM1_DISTANCE_SEGMENTS_ARRAY_SPEEDX10,
    CUSTOM2_DISTANCE_SEGMENTS_ARRAY_SPEEDX10,
    CUSTOM3_DISTANCE_SEGMENTS_ARRAY_SPEEDX10,
    CUSTOM4_DISTANCE_SEGMENTS_ARRAY_SPEEDX10,
    CUSTOM5_DISTANCE_SEGMENTS_ARRAY_SPEEDX10,
    CUSTOM1_DISTANCE_SEGMENTS_ARRAY_INCLINEX10,
    CUSTOM2_DISTANCE_SEGMENTS_ARRAY_INCLINEX10,
    CUSTOM3_DISTANCE_SEGMENTS_ARRAY_INCLINEX10,
    CUSTOM4_DISTANCE_SEGMENTS_ARRAY_INCLINEX10,
    CUSTOM5_DISTANCE_SEGMENTS_ARRAY_INCLINEX10,
    CUSTOM1_DISTANCE_SEGMENTS_ARRAY_RESISTANCE,
    CUSTOM2_DISTANCE_SEGMENTS_ARRAY_RESISTANCE,
    CUSTOM3_DISTANCE_SEGMENTS_ARRAY_RESISTANCE,
    CUSTOM4_DISTANCE_SEGMENTS_ARRAY_RESISTANCE,
    CUSTOM5_DISTANCE_SEGMENTS_ARRAY_RESISTANCE,
...
typedef struct{
    ...
    UINT8 minResistance;
    UINT8 isDemoModeOn;
    UINT8 isEnergySaverModeOn;
    UINT8 isBuzzerOn;
    UINT8 wasRTCPreset;
    UINT8 is24HoursFormat;
...
//    UCHAR timeFormat;
    ...
    UINT8   maxUserNumber;
    //------------------First Boot Flag------------------------------------------
	UINT8 IsMachineConfiged;
    UINT8 firstBootFlag;   // 0x1ㄛcleared; other first boot.
}
MACHINE_INFO;
...
typedef struct{
    ...
    char MFPtokenID[320];
    char MFPuserID[15];
    UINT8 WorkoutSummaryDataCount;
    struct
    {
        UINT16 workouttime;
        UINT16 workoutcalorie;
...
typedef struct
{
    ...
    UINT8 Walk_Speed;
    UINT8 Jog_Speed;
    UINT8 Walk_SpeedBuff;
    UINT8 Jog_SpeedBuff;
    UINT8 OldWalk_SpeedBuff;
    UINT8 OldJog_SpeedBuff;
    UINT8 Reset_Counts;
    UINT16 lastUpdateYear;
    UINT8 lastUpdateMonth;
    UINT8 lastUpdateDay;
...
typedef struct
{
    ...
    struct
    {
        UINT8 customSegmentNumber;
        UINT16 customWorkoutTotalTime;
        UINT16 customWorkoutTime[MAX_CUSTOM_SEGMENTS];
        UINT16 customSpeedX10[MAX_CUSTOM_SEGMENTS];
    ...
    {
        UINT8 customSegmentNumber;
        UINT16 customWorkoutDistance[MAX_CUSTOM_SEGMENTS];
        UINT16 customSpeedX10[MAX_CUSTOM_SEGMENTS];
        UINT8 customInclineX10[MAX_CUSTOM_SEGMENTS];
        UINT8 customresistance[MAX_CUSTOM_SEGMENTS];
    }Custom_Distance;//97
    struct
    {
        UINT8 customTargetHeartRate[MAX_CUSTOM_HR_SEGMENTS];
        UINT16 customHRTime[MAX_CUSTOM_HR_SEGMENTS];
        UINT16 customHRTotalTime;
    }Custom_HR;//10
}CUSTOM_CONFIG;
...
UCHAR SystemConfig_Set_CustomInfo(CUSTOM_CONFIG custominfo , UCHAR index);
CUSTOM_CONFIG SystemConfig_Get_CustomInfo(UCHAR UserIndex);
