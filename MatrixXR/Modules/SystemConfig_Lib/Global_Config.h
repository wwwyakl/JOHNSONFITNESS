...
#define USER2ENG_SPACETIME		3000
#define LENGTH_OF_PASSWORD	5
#define ENG_PASSWORD					"2001"
#define CLEARBOOT_PASSWORD	"2009"
...
typedef enum{
	...
	FACTORY_DEFFAULT_OVERSPEED_SWITCH,
	FACTORY_DEFFAULT_OVERSPEEDVALUE,
    ...
    FACTORY_ERROR_CODE_OFF      ,
    FACTORY_CONTROL_ZONE_ON     ,
    FACTORY_SECOND_CONTROL_ZONE_ON,
    FACTORY_IR_SENSOR_ON     ,
    FACTORY_RSCU_ON    ,
	FACTORY_DEFAULT_END
...
typedef enum
{
    ...
    MCB_RETAIL_CLIMBMILL  =0x19,//0X19,   //Retail Climbmill
...
typedef enum 
{
    ...
    VK_UP_LONGPRESSED,
    VK_DOWN_LONGPRESSED,
    VK_SPEEDUP_LONGPRESSED,
    VK_SPEEDDOWN_LONGPRESSED,
    VK_INCLINEUP_LONGPRESSED,
    VK_INCLINEDOWN_LONGPRESSED,
    VK_RESISTANCEUP_LONGPRESSED,
    VK_RESISTANCEDOWN_LONGPRESSED,
    VK_SAFEKEYOFF,
    VK_SPEEDUP,
    VK_SPEEDDOWN,
    VK_INCLINEUP,
    ...
    VK_SAFETY_KEY_ON,
    VK_NO_SPM_ERROR,
    VK_IRSENSOR_ERROR,//new7 增加irsensoreoor的vk
    VK_IRSENSOR_ERROR_RELEASED,//new7 增加irsensoreoor的vk  
    VK_CONTROLZONE_ERROR,
    VK_CONTROLZONE_ERROR_RELEASED,
    VK_UCBEMERG_ERROR,
    VK_UCBEMERG_ERROR_RELEASED,
    VK_HANDRAILEMERG_ERROR,
    VK_HANDRAILEMERG_ERROR_RELEASED,
    VK_DEMO_ERP_WAKEUP,
    VK_CHECK_WIFI_UPDATE,
    VK_LEAVE_UPDATE_STATUS,
    VK_LUBEBELT_RESET,
    VK_SPEEDOVER,
    VK_PROCESSED,
    VR_TOTAL_KEYS
...
typedef enum {
    ...
    FRMAE_STATE_SAFFKEYON   =  0x0C00,
	FRAME_STAGE_END  
}FRAME_STAGE;

typedef enum {
	RETURN_EVENT_HANDLER_START,
	RET_UNPROCESS_UNDISPLAY = RETURN_EVENT_HANDLER_START,
	RET_UNPROCESS_DISPLAY,
	RET_PROCESS_DISPLAY,
	RET_REFRESH_DISPLAY,
	RETURN_EVENT_HANDLER_END
}ReturnEventHandler;
...
#define MAX_OVERSPEED_VALUE	100	//10.0mile
#define MIN_OVERSPEED_VALUE	5	//0.5mile
#define INCLINE_ZERO_SHIFT		20


#define MAX_SUPPORTED_MODELS   32   //本仪表最多可支持32个机种型号

//#define C_LUBEBEL_DISTANCE	150000
#define C_LUBEBEL_DISTANCE	300000
#define C_LUBEBELT_EXTRA_DISTANCE	100

#define C_LUBEBEL_TIME	3600
#define C_LUBEBELT_EXTRA_TIME	120
#endif
