...
#undef DMA_SPI
//---------------------------Encoder Port--------------------//
#define Switch_A_PORT		gpioPortB
#define Switch_A_PIN		6
#define Switch_B_PORT		gpioPortB
...
#define HT1381_RST_PORT			    gpioPortB
#define HT1381_RST_PIN			    4
//---------------------------I2C_KEY Port--------------------//
...
#else
//---------------------RPM	Port------------------------//
#define RPM_PORT		gpioPortB
#define RPM_PIN		0

//---------------------------VR2 Port--------------------//
#define EMS_ECB_UP_PORT		gpioPortD
#define EMS_ECB_UP_PIN		0
#define EMS_ECB_DOWN_PORT		gpioPortD
#define EMS_ECB_DOWN_PIN		1

#define SVR1_PORT		gpioPortD
#define SVR1_PIN		4
#define VR2_PORT		gpioPortD
#define VR2_PIN		0
#define VR2_ADC_SPEED                   3000000
#define VR2_ADC_REFERENCE               adcRef2V5
#define VR2_ADC_Input                   adcSingleInpCh0
#define VR2_ADC_Resolution              adcRes12Bit  //adcResOVS
#endif

#ifdef AE
#define EMS_INCLINE_UP_PORT		gpioPortA
#define EMS_INCLINE_UP_PIN		12
#define EMS_INCLINE_DOWN_PORT	gpioPortA
#define EMS_INCLINE_DOWN_PIN	13
#define EMS_INCLINE_VR_PORT	              gpioPortD
#define EMS_INCLINE_VR_PIN	              7
#define INCLINE_VR_ADC_SPEED                   3000000
#define INCLINE_VR_ADC_REFERENCE               adcRef2V5
#define INCLINE_VR_ADC_Input                   adcSingleInpCh7 //adcSingleInpCh0
#define INCLINE_VR_ADC_Resolution              adcRes12Bit  //adcResOVS
#endif
...
#define BEEP_TIMER_ROUTE_LOCATION       LETIMER_ROUTE_LOCATION_LOC1
//---------------------------Audio Port--------------------//
...
//---------------------------LED_Driver Port--------------------//
#define TLC59282_DAT_PORT		gpioPortE
#define TLC59282_DAT_PIN		10

#define TLC59282_CLK_PORT		gpioPortE
#define TLC59282_CLK_PIN		12

#define TLC59282_OE_PORT		gpioPortE
#define TLC59282_OE_PIN			13

#define TLC59282_LE_PORT		gpioPortE
#define TLC59282_LE_PIN			11

//---------------------------LCD_Driver Port--------------------//
#define HT1650_DATA_PORT		gpioPortE
#define HT1650_DATA_PIN			0

//#define HT16XX_DAT1_PORT		gpioPortF
//#define HT16XX_DAT1_PIN			12

//#define HT16XX_DAT2_PORT		gpioPortA
//#define HT16XX_DAT2_PIN			11

//#define HT16XX_DAT3_PORT		gpioPortB
//#define HT16XX_DAT3_PIN			12

#define HT1650_CLK_PORT		    gpioPortE
#define HT1650_CLK_PIN			1
...
#define HT16XX_CS0_PORT			gpioPortE
#define HT16XX_CS0_PIN			4

#define HT1650_CS1_PORT			gpioPortF
#define HT1650_CS1_PIN			12
...
//-----------------------MONITOR UART Port------//
//---------------------------BT Module Port--------------------//
#define BT_UART_TX_PORT                 gpioPortA
#define BT_UART_TX_PIN                  3

#define BT_UART_RX_PORT                 gpioPortA
#define BT_UART_RX_PIN                  4

#define BT_RST_PORT			            gpioPortA
#define BT_RST_PIN		                14

#define DIGITAL_BT_UART                   UART0
#define DIGITAL_BT_UART_ROUTE_EN          UART_ROUTE_TXPEN | UART_ROUTE_RXPEN
#define DIGITAL_BT_UART_ROUTE_LOCATION    UART_ROUTE_LOCATION_LOC2

#define DIGITAL_BT_UART_Rx_IRQ            UART0_RX_IRQn
#define DIGITAL_BT_UART_Tx_IRQ            UART0_TX_IRQn
#define DIGITAL_BT_UART_STATUS            UART0->STATUS
#define DIGITAL_BT_UART_UARTTXC           UART_STATUS_TXC
