...
#ifdef AE
  Data.Level.Max_Level=16; //AFG3.7AE
#else
  Data.Level.Max_Level=10; //AFG3.7AT/HT
#endif
...
#else        
             ECB_Set_Resistance(Data_Get_Resistance(TARGET_RESISTANCE));//RES FIRST
////                ECB_Data_Updata();
#endif                
...
#else
          Incline_Set_Incline(Data_Get_Incline(TARGET_INCLINEX10));//INCLINE  SECOND
