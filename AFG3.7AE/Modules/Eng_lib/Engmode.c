  ...
  case SET_ENG1_1_BasicFunctions:
    {
      ...
      else if(keyevt.EventBits.Key_Start)
      {
        ...
        //                Incline_Set_Incline(Eng1_Set_InclineADC);
        //                Incline_TargetADC_Value = Eng1_Set_InclineADC;
...
#ifdef AE
        Eng1_Set_InclineADC +=w_Incline_ADC_Step;
        by_Incline++;
#else 
...
//                Incline_TargetADC_Value = Eng1_Set_InclineADC;
      ...
      else if(EngKey_evt.EventBits.Key_ResistanceUp)
      {
        ...
        LCB_Send_Cmd(DS_ECB_LOCATION,Eng1_Set_ECBCount);
#else
        if(Program_Get_Resistance(0)<=C_MAX_RESISTANCE)
          Data_Set_Resistance(Program_Get_Resistance(0)+1,0);
        else
          Data_Set_Resistance(C_MAX_RESISTANCE+1,0);       
...
void initEng1mode(void)
{
    ...
    by_Incline_old = 2;
    by_Incline = 0;
    Eng1_Set_InclineADC=SystemConfig_Get_Int(MIN_INLCINEADC_UINT16);    
#else 
...
bool Engmode_Set_VirtualKey(UINT16 vk)
{
     ...
     case VK_QK_INCLINE_80:
     case VK_QK_INCLINE_120:
     case VK_QK_INCLINE_160:
     case VK_QK_INCLINE_200:
     case VK_QK_RESISTACE_4:
     case VK_QK_RESISTACE_8:
     case VK_QK_RESISTACE_12:
     case VK_QK_RESISTACE_16:
     case VK_QK_RESISTACE_20:
#endif       
